...
public class Create_PDF {
    ...
    Create_PDF(byte[] img, int id) throws FileNotFoundException, DocumentException, SQLException, IOException {
        ...
        document.addTitle("Students ID Card");
        document.addSubject("Print Students ID");
        document.addAuthor("Developed By TYCO ROLL-NO:1,3,6 BATCH 2018-2021.");
        ...
        table.addCell(":");
        table.addCell(rs.getString("enroll_no"));
        ...
        if (Desktop.isDesktopSupported()) {
            try {
                ...
                System.out.println(e + "View_Form@80\n" + Arrays.toString(e.getStackTrace()));
            }
        }
        document.close();
        rs.close();
